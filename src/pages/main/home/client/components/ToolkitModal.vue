    ...
    return {
      ...
      calculators: [
        ...
        },
        {
          ...
          inputs: [{ id: "body_density", label: "Body density", value: null }],
          metric: "Body fat",
          units: "%",
        },
      ],
  ...
  methods: {
    ...
    calculate(cal) {
      switch (cal) {
        case "mhr_tanaka": {
          this.result =
            220 - Number(document.getElementById("input_age_tanaka").value);
          break;
        }
        case "mhr_gelish": {
          this.result = (
            220 -
            0.7 * Number(document.getElementById("input_age_gelish").value)
          ).toFixed(2);
          break;
        }
        case "hrr": {
        ...
        case "bf_siri": {
          this.result = (
            495 / Number(document.getElementById("input_body_density").value) -
            450
          ).toFixed(2);
          break;
        }
