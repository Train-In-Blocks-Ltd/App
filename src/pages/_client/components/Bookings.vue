...
<template>
    <div id="bookings">
        ...
        >
            ...
            >
                <div
                    v-for="(booking, bookingIndex) in getClientBookings(
                        bookings
                    )"
                    ...
                    <div class="status">
                        ...
                        <div class="options">
                            ...
                            <a
                                ...
                                class="a_link reject"
                                @click="
                                    cancelBooking(booking.id, booking.client_id)
                                "
                            >
                                {{
                                    booking.status === "Pending" &&
        ...
        <div v-else class="bookings_sub_container">
            ...
            <form
                class="request_booking_container"
            ...
            >
                <div class="date_time_wrapper">
                    <input
                        ...
                        required
                        @input="
                            (bookingForm.date = $event.target.value),
                                checkForm()
                        "
                    />
                    <input
                        ...
                        required
                        @input="
                            (bookingForm.time = $event.target.value),
                                checkForm()
                        "
                    />
                </div>
                <textarea
                    ...
                    required
                    @input="
                        (bookingForm.notes = $event.target.value), checkForm()
                    "
                />
    ...
    methods: {
        ...
        getClientBookings(bookings) {
            return bookings.filter(
                (booking) => booking.client_id === this.clientId
            );
        },
        checkForm() {
