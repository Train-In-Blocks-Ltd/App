        ...
        "content": [
          {
            ...
            "content": [
              {
                "text": ${JSON.stringify(
                    "Error Description: " + beautify(msg, null, 2, 100)
                )},
                "type": "text"
              }
            ]
          },
          {
            ...
            "content": [
              {
                "text": ${JSON.stringify(
                    "User Claims: " + beautify(claims, null, 2, 100)
                )},
                "type": "text"
              }
            ]
...
exports.handler = async function handler(event, context, callback) {
    if (event.headers.authorization) {
        ...
        if (event.httpMethod === "OPTIONS") {
            ...
            try {
                const atlassian = await axios.post(
                    "https://traininblocks.atlassian.net/rest/api/3/issue",
