            ...
            >
                ...
                <div class="bookings_sub_container">
                    <div
                        ...
                        class="bookings_wrapper"
                    >
                        <div
                            v-for="(
                                booking, bookingIndex
                            ) in clientUser.bookings"
                    ...
                    <p v-else class="grey">No bookings yet</p>
                    <form
                    ...
                    >
                        ...
                        <input
                            ...
                            :min="
                                bookingForm.date === today() ? timeNow() : null
                            "
                            class="small_border_radius"
                            type="time"
                            placeholder="Time"
                        ...
                        <textarea
                            ...
                            required
                            @input="
                                (bookingForm.notes = $event.target.value),
                                    checkForm()
                            "
                        />
