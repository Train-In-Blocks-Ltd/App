...
<template>
  <form
    id="policy_agreement"
    @submit.prevent="agreeToTerms(), willBodyScroll(true)"
  >
    <div id="policy" v-html="eula.html" />
    <p id="agree_statement">
      <b>
        By signing below, you agree to our End-User License Agreement, Privacy
        and Data Policy, Terms of Use, and Cookies Policy — all of which are
        designed to protect your information and maintain the quality of our
        services.
      </b>
    </p>
    <div class="confirmation">
      ...
      />
      <button :disabled="name === '' || disablePolicyAgreeButton">Agree</button>
    </div>
  </form>
</template>
