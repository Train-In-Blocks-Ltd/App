    ...
    <div v-if="!this.$parent.no_archive && !this.$parent.archive_error && this.$parent.archive_posts">
      ...
      <div v-for="(clients, index) in $parent.archive_posts"
        ...
        <div class="client_update">
          <span v-on:click="$parent.client_delete(clients.client_id, index)" title="Delete"><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none" class="transparent"/><path d="M6 21h12V7H6v14zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/></svg></span>
          <span v-on:click="$parent.client_unarchive(clients.client_id, index)" title="Unarchive"><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none" class="transparent"/><path d="M18.71 3H5.29L3 5.79V21h18V5.79L18.71 3zM14 15v2h-4v-2H6.5L12 9.5l5.5 5.5H14zM5.12 5l.81-1h12l.94 1H5.12z"/></svg></span>
        </div>
      </div>
    </div>
  </div>
