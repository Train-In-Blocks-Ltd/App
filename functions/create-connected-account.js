    ...
    if (event.httpMethod === 'OPTIONS') {
      ...
      try {
        ...
        const accountLinks = await stripe.accountLinks.create({
          account: account.id,
          refresh_url: event.multiValueHeaders.Referer && event.multiValueHeaders.Referer[0] === 'https://app.traininblocks.com/portfolio' ? 'https://app.traininblocks.com/portfolio' : 'https://dev.traininblocks.com/portfolio',
          return_url: event.multiValueHeaders.Referer && event.multiValueHeaders.Referer[0] === 'https://app.traininblocks.com/portfolio' ? 'https://app.traininblocks.com/portfolio' : 'https://dev.traininblocks.com/portfolio',
